---
title: "Associations between cortical thickness and WMH in UKBB and CHARGE"
output:
...
```{r, forestplot_old_young_zscored}
selelct_cat.levels = c("[45,53]", "(73,81]", "UKBB_all", "CHARGE")
...
ggsave("../results/age_specific_beta_F_M_wi_old_young_UKBB_CHARGE_zscored.png",
       width=12,height=6.5,units="in")
pdf("../results/age_specific_beta_F_M_wi_old_young_UKBB_CHARGE_zscored.pdf",
       width=12,height=6.5)
print(pF+pM)
dev.off()
```
...
#4. Correlation plot
```{r corrplot, fig.width=12, fig.height=5}
